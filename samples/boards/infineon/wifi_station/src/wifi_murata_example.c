/*
 * Copyright 2022, Cypress Semiconductor Corporation (an Infineon company) SPDX-License-Identifier: Apache-2.0
 *
...
static uint32_t num_scan_result;
...
void wifi_connect( void )
{
	...
	/* Attempt to connect to Wi-Fi until a connection is made or until MAX_WIFI_RETRY_COUNT attempts have been made.
	 */
...
void main( void )
{
	...
	static SD_HandleTypeDef SDHandle = { .Instance = SDIO };
