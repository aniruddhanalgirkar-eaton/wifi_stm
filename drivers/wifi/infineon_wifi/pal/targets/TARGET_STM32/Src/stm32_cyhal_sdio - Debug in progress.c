...
//ANN added below
    ...
    //obj->hsd->Init.ClockEdge           = SDIO_CLOCK_EDGE_RISING;//SDMMC_CLOCK_EDGE_RISING;
    //obj->hsd->Init.ClockPowerSave      = SDIO_CLOCK_POWER_SAVE_DISABLE;
    //obj->hsd->Init.BusWide             = SDIO_BUS_WIDE_4B;
    //obj->hsd->Init.HardwareFlowControl = SDIO_HARDWARE_FLOW_CONTROL_DISABLE;
...
//__HAL_RCC_SDIO_CLK_DISABLE();
    ...
    obj->hsd->Instance->CLKCR |= SDIO_CLKCR_CLKEN;
...
//ANN commented below for sometime
  // __SDMMC_CMDTRANS_ENABLE(obj->hsd->Instance);
        ...
        //ANN commented below for sometime 23.8
